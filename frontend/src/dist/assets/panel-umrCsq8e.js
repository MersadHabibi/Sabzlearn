import"./app-ukoE8fgy.js";import"./share-zDZSOXv8.js";import{A as y,f as i,_ as a}from"./utils-UJ-EUY8v.js";import{c as k,b as D,e as _,d as f,g as M}from"./usersAPIs-AQb3Emfp.js";import{a as q}from"./createCourseCard-fANfw4NU.js";const $=t=>{const e=document.querySelector("#courses__container");if(!t.courses.length){e.innerHTML='<p class="dark:text-white text-xl xs:col-span-2 lg:col-span-3 text-center font-DanaMedium mt-5"> شما در هیچ دوره ای ثبت نام نکردید </p>';return}e.innerHTML="",t.courses.forEach(r=>{e.insertAdjacentHTML("beforeend",`
