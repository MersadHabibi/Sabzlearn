...
const getAndShowCoursesForLastCourseSection = async () => {
...
getAndShowCoursesForLastCourseSection();
...
// Get and Show Presell Courses - not have presell course in database
